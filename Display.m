...
)&@(DimensionConvertion/@(Chop[Msumdat[#]]&/@{2,4,8}(*Reverse@*)(*Range[1,8]*)))
...
(* ::Input:: *)
(*Export[Which[$OperatingSystem=="Windows","NumFig/cs_4.19_0.749_zoom_2.eps",$OperatingSystem=="Unix","~/Github/2DScattering/NumFig/cs-0-1.eps"],fig,ImageResolution->300]*)
