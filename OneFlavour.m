...
\[ScriptCapitalI]1[\[Omega]1_,\[Omega]2_,opt:OptionsPattern[]][\[Phi]1_,\[Phi]2_,\[Phi]3_,\[Phi]4_][m_,M1_,M2_,M3_,M4_]:=-4 g^2 (NIntegrate[\[Omega]1 \[Omega]2 (\[Phi]1[(x \[Omega]2)/(1+\[Omega]2-\[Omega]1)]  \[Phi]4[x](\[Phi]2[y] \[Phi]3[y \[Omega]1]-\[Phi]2[(\[Omega]1-(1-x)\[Omega]2)/\[Omega]1] \[Phi]3[\[Omega]1-(1-x)\[Omega]2]-(y-(\[Omega]1-(1-x)\[Omega]2)/\[Omega]1)(\[Phi]2'[(\[Omega]1-(1-x)\[Omega]2)/\[Omega]1] \[Phi]3'[\[Omega]1-(1-x)\[Omega]2])))/((y-1) \[Omega]1+(1-x) \[Omega]2)^2,{x,0,1},{y,0,1},Evaluate[FilterRules[{opt},Options[NIntegrate]]]]);
\[ScriptCapitalI]2[\[Omega]1_,\[Omega]2_,opt:OptionsPattern[]][\[Phi]1_,\[Phi]2_,\[Phi]3_,\[Phi]4_][m_,M1_,M2_,M3_,M4_]:=-4 g^2 (NIntegrate[\[Omega]1 ( \[Phi]1[(x+\[Omega]2-\[Omega]1)/(1+\[Omega]2-\[Omega]1)] \[Phi]3[x]  (\[Phi]2[y]\[Phi]4[((y-1) \[Omega]1+\[Omega]2)/\[Omega]2]-\[Phi]2[x/\[Omega]1]\[Phi]4[(x- \[Omega]1+\[Omega]2)/\[Omega]2]-(y-x/\[Omega]1)(\[Phi]2'[x/\[Omega]1]\[Phi]4'[(x- \[Omega]1+\[Omega]2)/\[Omega]2])))/(y \[Omega]1-x)^2,{x,0,1},{y,0,1},Evaluate[FilterRules[{opt},Options[NIntegrate]]]]);
