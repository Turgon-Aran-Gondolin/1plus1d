...
(*\[ScriptCapitalC][f_Symbol[arg__]]:=f[#2/(1+#2-#1),#1/(1+#2-#1)]&[arg]
\[ScriptCapitalP][f_Symbol[arg__]]:=f[(1+#2-#1)/#2,1/#2]&[arg]*)
(*\[ScriptCapitalM]1[\[Omega]1_,\[Omega]2_][\[Phi]1_,\[Phi]2_,\[Phi]3_,\[Phi]4_][m_,Ma_,Mb_,Mc_,Md_]=((#+\[ScriptCapitalS][#])&[(*If[1>\[Omega]1,-4 g^2NIntegrate[(\[Omega]1 \[Omega]2)/((y-1) \[Omega]1+(1-x)\[Omega]2)^2\[Phi]1[(x \[Omega]2)/(1+\[Omega]2-\[Omega]1)]\[Phi]2[y]\[Phi]3[y \[Omega]1]\[Phi]4[x],{x,0,1},{y,0,1}],0]*)
\[ScriptCapitalI]1[\[Omega]1,\[Omega]2][\[Phi]1,\[Phi]2,\[Phi]3,\[Phi]4][m,Ma,Mb,Mc,Md]])+((#+\[ScriptCapitalC][#])&[(*If[\[Omega]2>\[Omega]1,-4 g^2NIntegrate[\[Omega]1/(y \[Omega]1-x)^2\[Phi]1[(x+\[Omega]2-\[Omega]1)/(1+\[Omega]2-\[Omega]1)]\[Phi]2[y]\[Phi]3[x]\[Phi]4[((y-1) \[Omega]1+\[Omega]2)/\[Omega]2],{x,0,1},{y,0,1}],0]*)
\[ScriptCapitalI]2[\[Omega]1,\[Omega]2][\[Phi]1,\[Phi]2,\[Phi]3,\[Phi]4][m,Ma,Mb,Mc,Md]])+((#+\[ScriptCapitalS][#]+\[ScriptCapitalP][#]+\[ScriptCapitalC][#])&[\[ScriptCapitalI]3[\[Omega]1,\[Omega]2][\[Phi]1,\[Phi]2,\[Phi]3,\[Phi]4][m,Ma,Mb,Mc,Md]]);*)
...
EXPR1[\[Omega]1_,\[Omega]2_][m_,Ma_,Mb_,Mc_,Md_][\[Phi]1_,\[Phi]2_,\[Phi]3_,\[Phi]4_]=EXPR[\[Omega]1,\[Omega]2][\[Phi]1,\[Phi]2,\[Phi]3,\[Phi]4][m,Ma,Mb,Mc,Md];
\[ScriptCapitalM]one[\[Omega]1_,\[Omega]2_][m_,Ma_,Mb_,Mc_,Md_][\[Phi]1_,\[Phi]2_,\[Phi]3_,\[Phi]4_]:=EXPR1[\[Omega]1,\[Omega]2][m,Ma,Mb,Mc,Md][\[Phi]1,\[Phi]2,\[Phi]3,\[Phi]4]
...
(*Used z=Subscript[r, 2-]/(Subscript[r, 1-]+Subscript[r, 2-]), \[Omega]=Subscript[r, 4-]/(Subscript[r, 1-]+Subscript[r, 2-]), Subscript[\[Omega], 1]=Subscript[r, 2-]/Subscript[r, 3-], Subscript[\[Omega], 2]=Subscript[r, 4-]/Subscript[r, 3-] here.
*)
(*\[Omega]2p[\[Omega]1_][M1_,M2_,M3_,M4_]:=(1/(2 (M3^2 \[Omega]1-M2^2))) (-\[Sqrt]((M1^2 (-\[Omega]1)+M2^2 \[Omega]1-M2^2-M3^2 \[Omega]1^2+M3^2 \[Omega]1+M4^2 \[Omega]1)^2-4 (M4^2 \[Omega]1-M4^2 \[Omega]1^2) (M3^2 \[Omega]1-M2^2))+M1^2 \[Omega]1-M2^2 \[Omega]1+M2^2+M3^2 \[Omega]1^2-M3^2 \[Omega]1-M4^2 \[Omega]1)(*transform \[Omega]1 to \[Omega]2, your definition, solution 1*)
