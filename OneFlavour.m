...
psi[n_,x_]:=psi[n,x]=If[m1>=Sqrt[2],Which[n==0,x^(2-\[Beta])*(1-x)^\[Beta],n==1,(1-x)^(2-\[Beta])*x^\[Beta],n>=2,Sin[(n-1)*\[Pi]*x]],Which[n==0,x^(2-\[Beta][[1]])*(1-x)^\[Beta][[1]],n==1,(1-x)^(2-\[Beta][[1]])*x^\[Beta][[1]],n==2,x^(2-\[Beta][[2]])*(1-x)^\[Beta][[2]],n==3,(1-x)^(2-\[Beta][[2]])*x^\[Beta][[2]],n>=4,Sin[(n-1)*\[Pi]*x]]];
